...
Proof.
  ...
  intros s t my_hypothesis.
  (* move the hypothesis into the context: *)
  (*intros H2.*)
  (* rewrite the goal using the hypothesis: *)
  rewrite -> my_hypothesis.
  reflexivity.  Qed.
...
Example test_bin_incr1 : incr (B (A (B Z))) = A (B (B Z)).
Proof. simpl. reflexivity. Qed.
Example test_bin_incr2 : bin_to_nat (B (A (B Z))) = 5.
Proof. simpl. reflexivity. Qed.
Example test_bin_incr3 : bin_to_nat (incr (B (A (B Z)))) = 6.
Proof. simpl. reflexivity. Qed.
Example test_bin_incr4 : incr Z = B Z.
Proof. simpl. reflexivity. Qed.
Example test_bin_incr5 : bin_to_nat Z = 0.
Proof. simpl. reflexivity. Qed.
